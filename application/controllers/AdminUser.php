...
class adminUser extends CI_Controller {
	...
	public function index() {
		...
		$data['oneUser'] = $this->user->getOneUser($this->session->userdata('COSTUME')['user_id']);
	...
	public function editUser() {
		...
		/* jika level user superAdmin */
		if($this->session->userdata('COSTUME')['level'] === 'superAdmin' || $user_id_input == $this->session->userdata('COSTUME')['user_id']) {
			...
			if(isset($_POST['submit'])) {
				...
				if(!$this->form_validation->run()) {
	                generate_errors(['nama','username','password'],false);
