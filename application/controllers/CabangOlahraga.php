...
* 
*/
class CabangOlahraga extends CI_Controller {
    ...
    //adalah fungsi yang pertama kali diakses, dan function index juga merupakan fungsi default, jika saat memanggil class tanpa menyebutkan fungsinya
    public function index() {
        $data['olahraga'] = $this->dashboard->getOlahraga(2);
        $this->template->load('template','dashboard/cabangOlahraga',$data);
    }
