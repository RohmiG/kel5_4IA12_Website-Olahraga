...
<div class="col-md-6 col-md-offset-3 nopadding-all marginTop60px">
	...
	<?= form_open_multipart('adminSettings/insertLogo',['class'=>'inputFile']); ?>
		<input type="file" id="inputFile" accept="image/*" name="logo">
		...
		<a href="<?= base_url('adminSettings/logo'); ?>" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span></a>
	</form>

	<div class="logo imgPriview marginTop60px marginBottom100px">
		<img src="">
	</div>
</div>