<!-- PAge user, bila admin or super admin. 
disini bisa menampilan user yang ada -->
<div class="col-md-4 marginTop60px <?php if($this->session->userdata('COSTUME')['level'] != 'superAdmin') echo 'col-md-offset-4'; ?>">
...
<?php if($this->session->userdata('COSTUME')['level'] === 'superAdmin') : ?>
